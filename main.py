...
class ProjectScannerApp:
    ...
    def setup_ui(self):
        ...
        ttk.Button(
            select_frame, text='☑ Выбрать всё', command=lambda: self.set_all_checks('☑')).pack(side=tk.LEFT, padx=10)
        ...
        ttk.Button(
            ...
            style='Action.TButton', command=self.generate_context
